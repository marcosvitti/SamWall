...
-- Schema projeto_nf
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `projeto_nf` ;

-- -----------------------------------------------------
-- Schema projeto_nf
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `projeto_nf` DEFAULT CHARACTER SET utf8mb4 ;
USE `projeto_nf` ;

-- -----------------------------------------------------
-- Table `projeto_nf`.`PEDIDO_COMPRA`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `projeto_nf`.`PEDIDO_COMPRA` ;

CREATE TABLE IF NOT EXISTS `projeto_nf`.`PEDIDO_COMPRA` (
  ...
  INDEX `fk_user_idx` (`ID_USER_FK` ASC) VISIBLE,
  INDEX `fk_fornecedor_idx` (`ID_FORNECEDOR_FK` ASC) VISIBLE,
  CONSTRAINT `fk_user`
...
-- -----------------------------------------------------
-- Table `projeto_nf`.`PRODUTO_PEDIDO`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `projeto_nf`.`PRODUTO_PEDIDO` ;

CREATE TABLE IF NOT EXISTS `projeto_nf`.`PRODUTO_PEDIDO` (
  ...
  INDEX `FK_PROD_idx` (`ID_PEDIDO_FK` ASC) VISIBLE,
  CONSTRAINT `FK_PROD`
...
-- -----------------------------------------------------
-- Table `projeto_nf`.`categoria`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `projeto_nf`.`categoria` ;

CREATE TABLE IF NOT EXISTS `projeto_nf`.`categoria` (
...
-- -----------------------------------------------------
-- Table `projeto_nf`.`colaboradores`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `projeto_nf`.`colaboradores` ;
...
CREATE TABLE IF NOT EXISTS `projeto_nf`.`colaboradores` (
  ...
  INDEX `colab` (`ID_USER` ASC) VISIBLE)
ENGINE = InnoDB
AUTO_INCREMENT = 9
DEFAULT CHARACTER SET = latin1;
...
-- -----------------------------------------------------
-- Table `projeto_nf`.`fornecedor`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `projeto_nf`.`fornecedor` ;
...
CREATE TABLE IF NOT EXISTS `projeto_nf`.`fornecedor` (
  ...
  INDEX `ID_FORNEC` (`ID_FORNECEDOR` ASC) VISIBLE,
  INDEX `FRN_CATEG_idx` (`ID_CATEGORIA_FK` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `projeto_nf`.`nf_a`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `projeto_nf`.`nf_a` ;
...
CREATE TABLE IF NOT EXISTS `projeto_nf`.`nf_a` (
  ...
  PRIMARY KEY (`ID_NF_A`),
  UNIQUE INDEX `NUM_NF_UNIQUE` (`NUM_NF` ASC) VISIBLE,
  INDEX `COLAB_idx` (`ID_COLAB_FK` ASC) VISIBLE,
  INDEX `fk_forn_idx` (`ID_FORNECEDOR_FK` ASC) VISIBLE,
  CONSTRAINT `A_COLAB`
...
-- -----------------------------------------------------
-- Table `projeto_nf`.`produto_nf`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `projeto_nf`.`produto_nf` ;
