...
public class AddNF extends javax.swing.JFrame {
    ...
    public AddNF(String login, String action) { // Método para instanciar o frame addUser
    ...
    private void limpaCampos() { // Método para limpar campos do formulário
        jTextFieldNumeroNF.setText(""); // Limpa campo Numero da nota fiscal
        jComboBoxPedidoCompra.setSelectedItem(0); // Limpa campo Fornecedor
        jComboBoxColaborador.setSelectedItem(0);// Limpa campo Colaborador
        jComboBoxFornecedor.setSelectedItem(0);// Limpa campo Colaborador
        jTextFieldQtdParcela.setText(""); //Limpa campo Quantidade parcela
    ...
    private void initComponents() {
        ...
        jTextFieldQtdParcela = new javax.swing.JTextField();
        ...
        jLabel11.setText("Quantidade de Parcela :");
        jPanel6.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 300, 310, 40));

        jTextFieldQtdParcela.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jTextFieldQtdParcela.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        jTextFieldQtdParcela.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldQtdParcelaKeyTyped(evt);
            }
        });
        jPanel6.add(jTextFieldQtdParcela, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 340, 310, 30));

        jLabel10.setFont(new java.awt.Font("Segoe UI", 0, 20)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel10.setText("Valor :");
        jPanel6.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 300, 310, 40));
        ...
        jPanel6.add(jComboBoxColaborador, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 270, 680, 30));
        ...
        jPanel6.add(jComboBoxFornecedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 200, 680, 30));
    ...
    private void jTextFieldQtdParcelaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldQtdParcelaKeyTyped
        sanitaze(Pattern.compile("[0-9]").matcher(Character.toString(evt.getKeyChar())), evt);
    }//GEN-LAST:event_jTextFieldQtdParcelaKeyTyped
...
//sanitaze(Pattern.compile("[a-zA-Z]|[0-9]|@|_|\\.").matcher(Character.toString(evt.getKeyChar())), evt);
    ...
    private javax.swing.JTextField jTextFieldQtdParcela;
