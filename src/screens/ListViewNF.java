...
public class ListViewNF extends javax.swing.JFrame {
    ...
    public ListViewNF(String login, String action) {
        ...
        //jTable1 = ControllerUser.listarUsers(jTable1, new String[] {}, this);
    ...
    private void limpaCampos() { // Método para limpar campos do formulário
        ...
        jComboBoxFornecedor.setSelectedItem(0); //Limpar campo fornecedor
        jTextFieldStatus.setText(""); // Limpa campo cargo
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "N° da Nota Fiscal", "Colaborador", "Fornecedor", "Valor", "Status", "Data Cadastro"
            }
        ) {
        ...
        jTextFieldStatus.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jTextFieldStatus.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldsKeyTyped(evt);
            }
        });
        jPanel1.add(jTextFieldStatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 380, 290, -1));
