...
public class EditUser extends javax.swing.JFrame {
    ...
    public EditUser(String username, DataBase con) {
        initComponents();
        setConnection(con);
    ...
    private void initComponents() {
        ...
        getContentPane().add(inserir, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 320, 70, -1));
        ...
        getContentPane().add(limpar, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 320, 70, -1));
        ...
        getContentPane().add(excluir, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 320, 70, -1));
        ...
        getContentPane().add(alterar, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 320, 70, -1));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, 380, 130));
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, 570, 160));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 364, 570, 180));

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pictures/background3.jpg"))); // NOI18N
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(-290, 0, 880, 560));
